<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplePaySample_V1.aspx.cs" Inherits="ApplePaySample_V1" %>
    ...
    <script type="text/javascript">
        ...
        function beginPayment() {
            ...
            session.onvalidatemerchant = function (event) {
                ...
                $.ajax({
                    url: "ApplePaySample_V1.aspx/validateMerchant",
                    method: "POST",
            ...
            session.onpaymentauthorized = function (event) {
                ...
                $.ajax({
                    url: "ApplePaySample_V1.aspx/paymentProcess",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify(data),
                    error: function (err) {
